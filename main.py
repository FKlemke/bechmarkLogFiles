...
#     toolBox.visusalizeValueSetsSubplot(titelName, plotVal1, plotVal2, testcase)
...
def visualizeCR():
    ...
    plotVal1, plotVal2 = toolBox.parseHeaderWrk2(sourcefile4, plotVal1, plotVal2, targetfile)
    plotVal1, plotVal2 = toolBox.parseHeaderWrk2(sourcefile5, plotVal1, plotVal2, targetfile)
    plotVal1, plotVal2 = toolBox.parseHeaderWrk2(sourcefile6, plotVal1, plotVal2, targetfile)
...
# sourcefile4 = './RawLogFiles/jsonVaporClientWrk2V3.txt'
# sourcefile5 = './RawLogFiles/jsonVaporClientWrk2V1.txt'
# sourcefile6 = './RawLogFiles/jsonKituraClientWrk2V1.txt'
